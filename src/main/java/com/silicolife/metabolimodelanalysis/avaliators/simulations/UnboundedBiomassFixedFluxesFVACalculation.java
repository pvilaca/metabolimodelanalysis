...
public class UnboundedBiomassFixedFluxesFVACalculation implements Evaluators<SteadyStateSimulationResult>{
	...
	//		test.removeAll(CountContainerZeroFluxes.zerosFluxes.get(obj.getModel().getId()));
